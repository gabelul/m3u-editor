...
if (($manifest['id'] ?? null) !== 'channel-normalizer') {
    fwrite(STDERR, "Expected plugin id channel-normalizer, found ".($manifest['id'] ?? 'unknown')."\n");
    exit(1);
}
...
echo "Validated channel-normalizer plugin files.\n";
